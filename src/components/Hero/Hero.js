...
function Hero() {
  ...
  return (
    <div className={`${styles.hero}`}>
      <main className={`${styles.hero__area}`} ref={myRef}>
        {visible && (
          <>
          ...
          <aside className={`${styles.hero__socials}`}>
            <div>
              <a 
                href="https://www.github.com/abalcs" 
                target="_blank" 
                className={`${styles.hero__social}`} 
                alt="my github repo link" rel="noreferrer">
              <svg 
            ...
            <div>
              <a 
                href="https://www.linkedin.com/in/alan-balcom/" 
                target="_blank" 
                className={`${styles.hero__social}`} 
