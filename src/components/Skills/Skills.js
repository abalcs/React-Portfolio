    ...
    return (
      ...
      <div >
        <ul className={`${style.list}`}>
          ...
          <li><a href="https://en.wikipedia.org/wiki/CSS" target="_blank" rel="noreferrer"><img src={css} className={`${style.skillIcon}`} alt="css"/></a></li>
          ...
          <li><a href="https://webpack.js.org/" target="_blank" rel="noreferrer"><img src={webpack} className={`${style.skillIcon}`} alt="webpack"/></a></li>
        </ul>
      </div>
